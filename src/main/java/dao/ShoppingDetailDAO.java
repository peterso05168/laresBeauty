...
public class ShoppingDetailDAO {
	...
	public Integer addShoppingDetailWithOrder(final Integer userId, final Integer productId,
			final Integer productQuantity, final String status, final Integer orderId) {
	...
	public Integer updateShoppingDetailQuantity(final Integer userId, final Integer productId,
